...
exports.mount = function (app) {
  ...
  app.all('/queues/:name*', function (req, res, next) {
    ...
    queues.list(function (err, queues) {
      ...
      req.bull = new Queue(queueName, util.redisPort(), util.redisHost(), {sharedClient: util.getRedisClient()});
  ...
  app.all('/debug*', function (req, res, next) {
    req.queue = new Queue('test', util.redisPort(), util.redisHost(), {sharedClient: util.getRedisClient()});
